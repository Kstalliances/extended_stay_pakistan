...
export const BookingPage = () => {
    ...
    function validateDates() {
        ...
        if (new Date(fromDate) < currentDate || new Date(toDate) < currentDate) {
            setModal(!modal);
            setErrorMessage('Oh no! you select the old dates. Please select valid dates.');
    ...
    function showErrorOnBooking(flag, message, timeout) {
        setError(flag);
                        ...
                        <Card className="mt-5 p-3" style={{boxShadow: 'rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px'}}>
                            ...
                            <Form style={{textAlign: "left"}}>
                                ...
                                <Row className="mt-3">
                                    ...
                                    <Col xl={3} lg={6} md={3} sm={4} xs={12}>
                                        <Tooltip placement="top" title="Pay on this number" className="acc">
